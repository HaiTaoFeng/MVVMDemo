...
import com.demo.tangminglong.mvvmprojecttest.databinding.ItemRepoBinding;
import com.demo.tangminglong.mvvmprojecttest.model.Repository;
import com.demo.tangminglong.mvvmprojecttest.viewmodel.ItemRepoViewModel;
...
public final class RepositoryAdapter extends RecyclerView.Adapter<RepositoryAdapter.RepositoryViewHolder> {
    ...
    public RepositoryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ItemRepoBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()),R.layout.item_repo,
                parent,
                false);
